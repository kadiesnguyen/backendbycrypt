...
Route::middleware(['auth:api', 'check.user.status'])->group(function () {
  ...
  Route::group(['prefix' => 'user'], function () {
    ...
    Route::get('verification', [UserController::class, 'verificationStatus']);
    ...
    Route::get('security/google/setup', [SecurityController::class, 'googleSetup']);
    Route::post('security/google/enable', [SecurityController::class, 'googleEnable']);
    Route::post('security/email/send-code', [SecurityController::class, 'emailSendCode']);
    Route::post('security/email/verify', [SecurityController::class, 'emailVerify']);
  });
